...
public class ColorUtils {
    ...
    /*
    colorList.add(new ColorName("Blue", 0xF0, 0xF8, 0xFF));
        ...
        colorList.add(new ColorName("Yellow", 0xBD, 0xB7, 0x6B));
        ...
        colorList.add(new ColorName("Yellow", 0x6B, 0x8E, 0x23));
        ...
        colorList.add(new ColorName("Orange", 0xCD, 0x85, 0x3F));
        ...
        colorList.add(new ColorName("Red", 0xFF, 0x63, 0x47));
    ...
    private ArrayList<ColorName> initColorList() {
        ...
        colorList.add(new ColorName("Green", 0x8F, 0xBC, 0x8F));
        colorList.add(new ColorName("Blue", 0x48, 0x3D, 0x8B));
        colorList.add(new ColorName("Blue", 0x2F, 0x4F, 0x4F));
        colorList.add(new ColorName("Blue", 0x00, 0xCE, 0xD1));
        colorList.add(new ColorName("DarkViolet", 0x94, 0x00, 0xD3));
        colorList.add(new ColorName("DeepPink", 0xFF, 0x14, 0x93));
        colorList.add(new ColorName("Blue", 0x00, 0xBF, 0xFF));
        colorList.add(new ColorName("Blue", 0x69, 0x69, 0x69));
        colorList.add(new ColorName("Blue", 0x1E, 0x90, 0xFF));
        ...
        colorList.add(new ColorName("Indigo", 0x4B, 0x00, 0x82));
        colorList.add(new ColorName("Ivory", 0xFF, 0xFF, 0xF0));
        colorList.add(new ColorName("Yellow", 0xF0, 0xE6, 0x8C));
        colorList.add(new ColorName("Lavender", 0xE6, 0xE6, 0xFA));
        colorList.add(new ColorName("LavenderBlush", 0xFF, 0xF0, 0xF5));
        ...
        colorList.add(new ColorName("Yellow", 0xFA, 0xFA, 0xD2));
        colorList.add(new ColorName("White", 0xD3, 0xD3, 0xD3));
        colorList.add(new ColorName("Green", 0x90, 0xEE, 0x90));
        colorList.add(new ColorName("LightPink", 0xFF, 0xB6, 0xC1));
        colorList.add(new ColorName("LightSalmon", 0xFF, 0xA0, 0x7A));
        ...
        colorList.add(new ColorName("Blue", 0x87, 0xCE, 0xEB));
        colorList.add(new ColorName("Blue", 0x6A, 0x5A, 0xCD));
        colorList.add(new ColorName("White", 0x70, 0x80, 0x90));
        colorList.add(new ColorName("White", 0xFF, 0xFA, 0xFA));
        colorList.add(new ColorName("Green", 0x00, 0xFF, 0x7F));
        colorList.add(new ColorName("Blue", 0x46, 0x82, 0xB4));
        colorList.add(new ColorName("White", 0xD2, 0xB4, 0x8C));
        ...
        colorList.add(new ColorName("White", 0xF5, 0xF5, 0xF5));
        colorList.add(new ColorName("Yellow", 0xFF, 0xFF, 0x00));
        colorList.add(new ColorName("Yellow", 0x9A, 0xCD, 0x32));
    ...
    public String getColorNameFromRgb(int r, int g, int b) {
        ...
        if (closestMatch != null) {
            Log.i(TAG, "Octal color : " +  closestMatch.getR() + " " + closestMatch.getB() + " " + closestMatch.getG());
